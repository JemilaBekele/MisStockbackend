...
// Get a space by ID
router.get('/api/space/:id', auth, spaceController.getSpaceById);

// Get all spaces
router.get('/api/spaces', auth, spaceController.getAllSpaces);
...
// Delete a space
router.delete('/api/space/:id', auth, spaceController.deleteSpace);
